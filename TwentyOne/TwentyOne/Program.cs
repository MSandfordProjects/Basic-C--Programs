        ...
        static void Main(string[] args)
        {
            ...
            if (playerName.ToLower() == "admin")
            {
                ...
                foreach (var exception in Exceptions)
                {
                    ...
                    Console.Write(exception.ExpcetionMessage + " | ");
            ...
            if (answer == "yes" || answer == "yeah" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\viole\Documents\GitHub\basic_c#_programs\Basic-C--Programs\TwentyOne\TwentyOne\logs\log.txt", true))
                {
